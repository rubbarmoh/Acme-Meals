...
<div>
	<a href="welcome/index.do" ><img src="images/logo.png" alt="Acme-Meals Co., Inc." /></a>
</div>
...
<div>
	<ul id="jMenu">
		...
		<security:authorize access="hasRole('ADMIN')">
			<li><a class="fNiv"><spring:message	code="master.page.administrator" /></a>
				<ul>
					...
					<li><a href="administrator/banUnban/browseBanned.do"><spring:message code="master.page.administrator.browseBanned" /></a></li>						
				</ul>
			</li>
		...
		<security:authorize access="hasRole('MANAGER')">
			...
			<li><a class="fNiv" href="managerActor/promote/list.do"><spring:message code="master.page.promote.list" /></a></li>
			<li><a class="fNiv" href="managerActor/dashboard.do"><spring:message code="master.page.dashboard" /></a></li>
			<li><a class="fNiv" href="socialIdentity/browse.do"><spring:message code="master.page.socialIdentities" /></a></li>
