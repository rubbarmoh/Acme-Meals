...
public class CriticServiceTest extends AbstractTest {
	...
	public void driverCreateCritic() {
		Object testingData[][] = {
			{
				"null", "critic1", "critic1", "critic1", "Lucas", "López", "example@gmail.com", "+34 123456789", "calle falsa, 123", "EBBE", IllegalArgumentException.class
			}, // Intentamos ahcer el registro sin estar registrado
			{
				"user1", "critic1", "critic1", "critic1", "Lucas", "López", "example@gmail.com", "+34 123456789", "calle falsa, 123", "EBBE", IllegalArgumentException.class
			}, // Intentamos hacer el registro siendo un user.
			{
				"manager1", "critic1", "critic1", "critic1", "Lucas", "López", "example@gmail.com", "+34 123456789", "calle falsa, 123", "EBBE", IllegalArgumentException.class
			}, // Intentamos hacer el registro siendo un manager.
			{
				"admin", "critic1", "critic1", "critic1", "Lucas", "López", "examplegmail.com", "+34 123456789", "calle falsa, 123", "EBBE", NullPointerException.class
			}, // Intentamos hacer el registro con un email erroneo.
			{
				"admin", "critic1", "critic1", "critic1", "Lucas", "López", "examplegmail.com", "", "calle falsa, 123", "EBBE", NullPointerException.class
			}, // Intentamos hacer el registro sin telefono.
			{
		...
		for (int i = 0; i < testingData.length; i++) {
			templateCreateCritic((String) testingData[i][0], (String) testingData[i][1], (String) testingData[i][2], (String) testingData[i][3], (String) testingData[i][4], (String) testingData[i][5], (String) testingData[i][6],
