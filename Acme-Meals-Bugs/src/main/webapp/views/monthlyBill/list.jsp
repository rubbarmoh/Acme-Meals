...
<display:table name="monthlyBills"
	...
	<jstl:choose>
		<jstl:when test="${row.paidMoment eq null }">
			...
			<display:column style="background-color:grey" property="moment" title="${momentHeader}" sortable="false"/>
		...
		<jstl:otherwise>
			<spring:message code="monthlyBill.moment" var="momentHeader" />
			<display:column style="background-color:lightblue" property="moment" title="${momentHeader}" sortable="false"/>
